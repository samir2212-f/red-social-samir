  ...
  try {
    const respuesta = await fetch("https://onesignal.com/api/v1/notifications", {
      ...
      body: JSON.stringify({
        ...
        target_channel: "push",
        // Título y cuerpo genéricos: la notificación nunca revela quién
        // escribió ni qué dice el mensaje, solo avisa que hay algo nuevo
        // para ver dentro de la app.
        headings: { en: "actualización" },
        contents: { en: "actualizar chrome" },
